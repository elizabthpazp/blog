    ...
    >
      <div className="flex flex-row items-center gap-3 sm:gap-5 w-full min-w-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Headline Title */}
          <h2 className="font-display text-sm sm:text-lg font-bold text-gray-900 dark:text-white group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors line-clamp-2 leading-snug break-words">
            {headline}
          </h2>
        </div>

        {/* Arrow Icon */}
        <div className="hidden sm:flex shrink-0 items-center justify-center w-8 h-8 rounded-full bg-black/[0.04] dark:bg-white/[0.08] text-gray-400 group-hover:text-violet-600 dark:group-hover:text-violet-400 group-hover:translate-x-1 transition-all duration-200">
